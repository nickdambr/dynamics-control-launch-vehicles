...
rl_fig(Lful, 'Root locus of the full Task-2 loop (zoom near the origin)', ...
       'task2_rootlocus', fig_dir, [-16 3], [-3 3]);   % tight low-frequency zoom: rigid-body + lateral-drift capture and the -2.5/-15 real zeros (bending +/-19, notch and the far Pade zeros are shown in the full view below)
